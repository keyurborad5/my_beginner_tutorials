 ...
 * @brief This is a subcriber cpp file which subscribers and loggs the custom
 * message
 * @version 0.1
 * @date 2024-11-08
 *
...
/**
 * @brief MySubscriber Class to define a subscriber that logs the message
...
class MySubscriber : public rclcpp::Node {
 public:
  ...
  MySubscriber() : Node("my_subscriber") {
    ...
    // Flag for logging the error message if subscriber node is running and
    // publisher is not
    msg_received_ = false;
 ...
 private:
  ...
  /**
   * @brief check_for_msgs member method to check is any message is received
